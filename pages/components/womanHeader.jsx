...
const WomanHeader = () => {
  ...
  <div className="w-full bg-womanHeader bg-no-repeat bg-cover" style={{height: '1000px'}}>
      <div className="flex flex-row text-3xl font-semibold p-5 text-white">
        <Link href='/catalog'><h3 className="ml-auto">Catalog</h3></Link>
        <Link href="/contact"><h3 className="ml-10">Contact</h3></Link>
        <Link href="/about"><h3 className="ml-10">About</h3></Link>
