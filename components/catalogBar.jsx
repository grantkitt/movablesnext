    ...
    <div className='barNshit'>
        <div className="flex flex-row p-6" style={{backgroundColor: '#B6DCFF'}}>
          <Link href="/">
            ...
            <input type="text" onKeyDown={e => searchFunc(e)} placeholder='search name, type, genre' className='border-none h-8 my-auto w-72 xl:w-96 pl-2 rounded-md active:border-none ml-2 xl:ml-auto mr-5  bg-white'/>
            <div className="lg:flex lg:flex-row my-auto text-2xl font-bold hidden">
              <Link href="/catalog"><h3 className="mr-10 cursor-pointer">Catalog</h3></Link>
                <Link href="/contact"><h3 className="mr-10 cursor-pointer">Contact</h3></Link>
                <Link href="/about"><h3 className="mr-10 cursor-pointer">About</h3></Link>
