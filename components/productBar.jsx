    ...
    <div className='barNshit'>
        <div className="flex flex-row p-6" style={{backgroundColor: '#B6DCFF'}}>
          <Link href="/">
            ...
            <div className="hidden lg:flex lg:flex-row p-4 bg-white rounded-2xl font-bold ml-24 cursor-pointer">
            ...
            <div className="flex flex-row my-auto text-xl lg:text-2xl font-bold ">
              <Link href="/catalog"><h3 className="lg:mr-10 mr-5 cursor-pointer">Catalog</h3></Link>
                ...
                <Link href="/about"><h3 className="lg:mr-10 mr-5 cursor-pointer">About</h3></Link>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#000000" className="w-7 h-7 mt-1 mr-auto">
